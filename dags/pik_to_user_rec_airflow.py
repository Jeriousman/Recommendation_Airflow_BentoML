...
with DAG(
    dag_id='pik_to_user_rec_airflow',
    ...
    task_clear_bento = BashOperator(   ##이전 bentoml model들을 모두 지운다
            ...
            bash_command=
            """ 
                bentoml delete pik_to_user_recommender_bento --yes; bentoml models delete pik_to_user_recommender_model --yes; echo "Job continued"  
            """
            )
    ...
    task_make_bento_model = PythonOperator(
        ...
        op_kwargs={
            ...
            'bentoml_model_name' : 'pik_to_user_recommender_model',
        }
    )
    ...
    task_create_bento = BashOperator(   ##이전 bentoml model들을 모두 지운다
        ...
        """ 
            cd /opt/airflow/dags/bentoml/pik_to_user_rec_bento; bentoml build
        """
        )
    ...
    task_serve_bentoml = BashOperator(
        ...
        """ 
            ...
            fuser -k 3002/tcp; bentoml serve -p 3002 pik_to_user_recommender_bento:latest --production
        """
        )
