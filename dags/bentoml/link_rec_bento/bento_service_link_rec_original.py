...
# class fasttext_runnable(bentoml.Runnable):
#     SUPPORTED_RESOURCES = ("cuda",)
#     SUPPORTS_CPU_MULTI_THREADING = True

#     def __init__(self):
#         # load the model instance
#         self.language_predictor = fasttext.load_model(path_to_pretrained_model)

#     @bentoml.Runnable.method(batchable=False)
#     def predict_lang(self, input_data):
#         return self.language_predictor.predict(input_data)

# fasttext_runner = bentoml.Runner(fasttext_runnable, models=[fasttext_model])


# runner.init_local()
# svc = bentoml.Service("link_recommender_bento", runners=[runner])
svc = bentoml.Service("link_recommender_bento", runners=[distilbert_runner, sentence_transformers_runner])
