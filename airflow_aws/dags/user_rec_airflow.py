...
with DAG(
    ...
    task_clear_bento = BashOperator(   ##이전 bentoml model들을 모두 지운다
            ...
            bash_command=
            """ 
                bentoml delete user_recommender_bento --yes; bentoml models delete user_recommender_model --yes; echo "Job continued"  
            """
            )
    ...
    task_make_bento_model = PythonOperator(
        ...
        op_kwargs={
            ...
            'bentoml_model_name' : 'user_recommender_model',
        }
    )
    ...
    task_create_bento = BashOperator(   ##이전 bentoml model들을 모두 지운다
        ...
        bash_command=
        # cd /home/ubuntu/airflow/dags/bentoml/pik_rec_bento; bentoml build
        """ 
            
            cd /home/ubuntu/airflow/dags/bentoml/user_rec_bento; bentoml build  
        """
        )
    ...
    task_serve_bentoml = BashOperator(
        ...
        # fuser -k 3000/tcp; 
        """ 
           sudo kill -9 `sudo lsof -t -i:3000`; bentoml serve -p 3000 user_recommender_bento:latest --production
        """
        )
