...
with open("/home/ubuntu/airflow/dags/data/linktitle_emb_vec.json") as f:  ##avg_{data_type}_vec.pickle  avg_pik_vec.json or avg_user_vec.json
...
with open("/home/ubuntu/airflow/dags/data/num_link_by_user.json") as f:
    num_link_by_pik = json.load(f)
...
lsh = lshashpy3.LSHash(hash_size=20, input_dim=768, num_hashtables=10,
    ...
    matrices_filename='/home/ubuntu/airflow/dags/data/lsh_matrices_filename.npz',
    hashtable_filename='/home/ubuntu/airflow/dags/data/lsh_hashtables_filename.npz',
    overwrite=False)
