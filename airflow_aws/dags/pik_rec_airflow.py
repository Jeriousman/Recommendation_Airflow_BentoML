...
with DAG(
    ...
    task_serve_bentoml = BashOperator(
        ...
        """ 
            ...
            sudo kill -9 `sudo lsof -t -i:3001`; bentoml serve -p 3001 pik_recommender_bento:latest --production
        """
        )
    ...
    #         'vec_path': '/home/ubuntu/airflow/dags/data/pik_vec.json',
    #         'piktitle_vec_path' : '/home/ubuntu/airflow/dags/data/piktitle_emb_vec.json',
    #         'num_link_by_pik_path': '/home/ubuntu/airflow/dags/data/num_link_by_pik.json',
    #         'processed_data_path' : '/home/ubuntu/airflow/dags/data/processed_data.csv',
