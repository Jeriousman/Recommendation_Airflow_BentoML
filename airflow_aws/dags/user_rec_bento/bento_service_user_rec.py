...
# df = pd.read_csv("/home/ubuntu/airflow/dags/data/light_processed_data.csv")

# with open("/home/ubuntu/airflow/dags/data/pik_lang_dict.json") as f:
#     pik_lang_dict = json.load(f)

with open("/home/ubuntu/airflow/dags/data/user_vec.json") as f:  ##avg_{data_type}_vec.pickle  avg_pik_vec.json or avg_user_vec.json
...
user_friend_list = pd.read_csv("/home/ubuntu/airflow/dags/data/users_following.csv")
