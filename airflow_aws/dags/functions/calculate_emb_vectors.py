...
def calculate_emb(**kwargs):
    default_path = kwargs.get('default_path', '/home/ubuntu/airflow/dags')
    ...
    dataloader_path = kwargs.get('dataloader_path', '/home/ubuntu/airflow/dags/data/link_title_dataloader.pickle')   
    ...
    if which_emb == 'linktitle_emb':
        ...
        train_save_lsh(hash_size=20,
                        input_dim=768,
                        num_hashtables=10,
                        matrices_filename='{default_path}/data/lsh_matrices_filename.npz',
                        hashtable_filename='{default_path}/data/lsh_hashtables_filename.npz',
        ...
        with open("{default_path}/data/pik_vec.json", "w") as f:
        ...
        with open('{default_path}/data/num_link_by_pik.json', 'w') as f:
            json.dump(num_link_by_pik, f)


        user_pik = get_links_by(processed_data, 'user_id', 'pik_id')
        with open('{default_path}/data/user_pik.json', 'w') as f:
            json.dump(user_pik, f)

        user_link = get_links_by(processed_data, 'user_id', 'link_id')
        with open('{default_path}/data/user_link.json', 'w') as f:
        ...
        with open('{default_path}/data/num_link_by_user.json', 'w') as f:
        ...
        with open("{default_path}/data/user_vec.json", "w") as f:
